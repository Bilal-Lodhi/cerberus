...
| [release/v0.5.0-checklist.md](release/v0.5.0-checklist.md) | Maintainers | **Prepared, not executed.** The gates verified in this cycle with their results, the publication steps left to run, and what must never happen in the publication step. |
