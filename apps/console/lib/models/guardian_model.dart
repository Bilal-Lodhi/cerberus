// ═══════════════════════════════════════════════════════════════════
// CERBERUS — Insider Threat & Data Exfiltration Guardian Model
// ═══════════════════════════════════════════════════════════════════
// Models the real-time risk assessment output contract from the
// Hono API guardian endpoint backed by the OpenAI-backed provider.
//
// Field names match the TypeScript types in
// apps/api/src/types.ts exactly (camelCase).
