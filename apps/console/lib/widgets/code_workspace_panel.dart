...
/// ─── CERBERUS — Interactive Employee Terminal Workspace ───────────────
...
class _CodeWorkspacePanelState extends State<CodeWorkspacePanel>
  ...
  Future<void> _sendTabSwitchEvent() async {
    ...
    // Query the actual browser document visibility state through a
    // platform-conditional helper, so this widget also compiles for the Dart
    // VM and the automated tests can run. Off the web it returns 'unknown'.
    final visibilityState = documentVisibilityState();
...
''';
      default:
        return '''// CERBERUS — Financial Terminal Workspace
...
void main() {
  ...
  print('CERBERUS Terminal — Active');
}
''';
    }
  }
